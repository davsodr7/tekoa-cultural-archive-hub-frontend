          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  O Tekoá Cultural Archive Hub serve como uma ponte entre as comunidades indígenas brasileiras
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              <div className="relative aspect-video">
                <img
                  src="/src/assets/danca-ritual-indigena-Brasil.jpeg"
              ...
              <div className="relative aspect-video">
                <img
                  src="/src/assets/artesanato-indígena-brasileiro.jpg"
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-8">
                O Tekoá Cultural Archive Hub reúne membros de comunidades indígenas, educadores, pesquisadores
              ...
              <div className="relative aspect-video max-w-3xl mx-auto">
                <img
                  src="/src/assets/foto_fogueira_gr.jpg"
